...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							...
							<a href="new_user.php"><button type="button" class="btn btn-primary">Add New User</button></a>
							</div>
							...
							<tr>
								...
								<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/online_crime/s_admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
