...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',address='$address',country='$country' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
 ...
 ?>                     
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']);?> Profile</h4>
...
if($userphoto==""):
?>
<img src="userimages/noimage.png" width="180" height="180" >
